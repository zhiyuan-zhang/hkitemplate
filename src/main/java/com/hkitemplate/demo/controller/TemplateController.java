...
// -------------------------rest 风格的api------------------------------------
	...
	public ResultBean<Boolean> insertDemoInfo(@RequestParam("id") String id, @RequestParam("name") String name,
		...
		return new ResultBean<Boolean> (infoserver.insert(new DemoInfo(description, description, 0, name, description, description, null, description, description, description, description)));
	}

	@RequestMapping(value = "/demo/{id}", method = RequestMethod.GET)
	public ResultBean<List<DemoInfo>> findDemoInfo(@PathVariable int id) {
	...
	private ResultBean<Boolean> deleteDemoteInfo(@PathVariable int id) {
